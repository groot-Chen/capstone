...
# test_loss: 0.333111
# accuracy: 0.901664
# precision_macro: 0.894617
# recall_macro: 0.901947
# f1_macro: 0.897561
# precision_weighted: 0.903495
# recall_weighted: 0.901664
# f1_weighted: 0.901885

# ===== Per-class Metrics =====
#     class_name  precision    recall  f1_score  support
# 0         call   0.895023  0.914048  0.904435     1082
# 1      dislike   0.868914  0.947712  0.906604     1224
# 2         fist   0.881423  0.913186  0.897023     1221
# 3         four   0.956441  0.847987  0.898955     1217
# 4   hand_heart   0.997065  0.985495  0.991246     2413
# 5         like   0.813623  0.899090  0.854224     1209
# 6   no_gesture   0.917004  0.906000  0.911469     1000
# 7           ok   0.889803  0.897181  0.893476     1206
# 8          one   0.811067  0.831442  0.821128     1234
# 9        peace   0.853561  0.884536  0.868773     2425
# 10       point   0.890052  0.927062  0.908180     1467
# 11        stop   0.914170  0.935377  0.924652     2414
# 12       three   0.940518  0.868919  0.903302     3967
# 13      two_up   0.895969  0.869218  0.882391     2378

# All results saved to: D:\gesture-recognition\resluts\resnet18
import os
import json
...
CHECKPOINT_PATH = r"D:\gesture-recognition\valid_resluts\resnet18\best_resnet18.pth"
OUTPUT_DIR = r"D:\gesture-recognition\testing_resluts\resnet18"
...
def build_model(num_classes: int):
    ...
    fc_head = model.fc
    if not isinstance(fc_head, nn.Linear):
        raise TypeError("ResNet18 fc head is not nn.Linear")
    model.fc = nn.Linear(fc_head.in_features, num_classes)
    return model
