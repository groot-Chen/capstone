...
# test_loss: 0.348182
# accuracy: 0.909678
# precision_macro: 0.901272
# recall_macro: 0.913543
# f1_macro: 0.906797
# precision_weighted: 0.910992
# recall_weighted: 0.909678
# f1_weighted: 0.909780

# ===== Per-class Metrics =====
#     class_name  precision    recall  f1_score  support
# 0         call   0.865417  0.939002  0.900709     1082
# 1      dislike   0.954770  0.948529  0.951639     1224
# 2         fist   0.906423  0.936118  0.921031     1221
# 3         four   0.799707  0.895645  0.844961     1217
# 4   hand_heart   0.998749  0.992540  0.995635     2413
# 5         like   0.909331  0.854425  0.881023     1209
# 6   no_gesture   0.913958  0.956000  0.934506     1000
# 7           ok   0.850746  0.898010  0.873739     1206
# 8          one   0.838963  0.865478  0.852014     1234
# 9        peace   0.899087  0.852371  0.875106     2425
# 10       point   0.914586  0.948875  0.931415     1467
# 11        stop   0.940075  0.935791  0.937928     2414
# 12       three   0.929494  0.870683  0.899128     3967
# 13      two_up   0.896508  0.896131  0.896320     2378

# All results saved to: D:\gesture-recognition\resluts\mobilenetv3
import os
import json
...
CHECKPOINT_PATH = r"D:\gesture-recognition\valid_resluts\mobilenetv3\best_mobilenetv3.pth"
OUTPUT_DIR = r"D:\gesture-recognition\testing_resluts\mobilenetv3"
...
def build_model(num_classes: int):
    # Must match the architecture used in training checkpoint.
    model = models.mobilenet_v3_large(weights=None)
    head = model.classifier[-1]
    if not isinstance(head, nn.Linear):
        raise TypeError("Expected MobileNetV3 classifier final layer to be nn.Linear")
